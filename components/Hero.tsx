      ...
      <div className="relative flex min-h-screen flex-row">
        ...
        >
          <div className="flex h-full flex-col justify-center">
            <h1 className="absolute right-[-50%] top-[50%] rotate-90 space-x-4 md:right-0">
              ...
              <span className="text-gray-950">Oliveira</span>
            </h1>
          </div>
        </div>
        <div className="flex w-10/12 flex-col-reverse items-center justify-center md:flex-row md:items-end">
          <div className="px-6 pb-16 pt-5" data-aos="fade-down">
            <h2 className="text-yellow-500">Desenvolvedor de Aplicações</h2>
            <br />
            <div className="flex justify-end">
              <a target="_blank" href="https://www.linkedin.com/in/samuel-fernandes-400587182/">
            ...
            <div className="mt-10 flex flex-col gap-10">
              <div
                ...
                data-aos-delay="300"
              >
                <h3 className="text-gray-100">4+</h3>
              ...
              <div
                ...
                data-aos-delay="300"
              >
                <h3 className="text-gray-100">30+</h3>
                <p className="text-gray-200">Projetos criados</p>
              </div>
            </div>
          </div>
